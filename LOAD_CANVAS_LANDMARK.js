...
const CANVAS_PLUGIN = {
	loadCanvasHTML: () => {
		$("#CANVAS_PLUGIN").html(
			...
			`<canvas id="CONFIG_CANVAS" width=900 height=700 style="height:100%;  border:none;background: transparent;"></canvas>`
	...
	draw: async function (door_info) {
		...
		// Disclaimer
		ctx.font = '20px Arial'; ctx.fillStyle = "#333"; ctx.textAlign = "center";
