...
#NAVIGATION_SPC .radio-layout--selected {
    font-weight: 600;
}

#NAVIGATION_SPC .radio-layout--selected i {
    transform: scale(1.05);
}

#NAVIGATION_SPC .radio-layout--selected .fa:before,
#NAVIGATION_SPC .radio-layout--selected .fas:before,
#NAVIGATION_SPC .radio-layout--selected .far:before {
    font-weight: 900 !important;
}

.cobalt.autodesk360 .navigation-tab .fas:before,
.cobalt.autodesk360 .navigation-tab .far:before,
.cobalt.autodesk360 .navigation-tab .fa:before {
...
.postion-container {
    ...
    .disabled{
      background-color: ${COLORS.gray500} !important;
...
.window-position-container .rw-button 
...
.window-position-title::before,
.window-position-title::after {
    content: "";
    width: 60px;
    height: 1px;
    background: ${COLORS.gray500};
...
.cobalt.autodesk360 .operator-carousel-wrapper .operator-arrow {
    width: 44px;
...
.cobalt.autodesk360 .operator-carousel-wrapper .operator-arrow:hover {
    background: ${COLORS.gray100};
}

.cobalt.autodesk360 .operator-carousel-wrapper .operator-arrow svg {
    width: 16px;
    height: 16px;
    fill: #1e325c;
    pointer-events: none;
...
.cobalt.autodesk360 .operator-pagination {
    display: flex;
    justify-content: center;
    align-items: center;
    gap: 10px;
...
.cobalt.autodesk360 .operator-pagination .operator-dot {
...
.cobalt.autodesk360 .operator-pagination .operator-dot:hover {
    background: ${COLORS.gray500} !important;
}

.cobalt.autodesk360 .operator-pagination .operator-dot.operator-dot-active {
...
.cobalt.autodesk360 .operator-pagination .operator-dot.active {
    background: #2f5dff !important;
}
